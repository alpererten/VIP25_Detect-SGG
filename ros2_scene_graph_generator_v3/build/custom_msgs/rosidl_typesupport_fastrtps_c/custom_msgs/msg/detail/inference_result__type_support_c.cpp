  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const custom_msgs__msg__InferenceResult * ros_message = static_cast<const custom_msgs__msg__InferenceResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_custom_msgs__msg__InferenceResult(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  custom_msgs__msg__InferenceResult * ros_message = static_cast<custom_msgs__msg__InferenceResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_custom_msgs__msg__InferenceResult(cdr, ros_message);
}
