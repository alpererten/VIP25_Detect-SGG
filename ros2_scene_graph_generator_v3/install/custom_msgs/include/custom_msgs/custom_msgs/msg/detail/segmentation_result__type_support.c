...
static rosidl_typesupport_introspection_c__MessageMember custom_msgs__msg__SegmentationResult__rosidl_typesupport_introspection_c__SegmentationResult_message_member_array[7] = {
  {
    "class_id",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs__msg__SegmentationResult, depth),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
